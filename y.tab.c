...
SymbolTable* table;
    ...
    SymbolValue* findSymbol(SymbolTable* table, char* symbol);
...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    token_entero = 260,            /* token_entero  */
    token_real = 261,              /* token_real  */
    token_identificador = 262,     /* token_identificador  */
    token_cadena = 263,            /* token_cadena  */
    suma = 264,                    /* suma  */
    resta = 265,                   /* resta  */
    multi = 266,                   /* multi  */
    divi = 267,                    /* divi  */
...
#define token_entero 260
#define token_real 261
#define token_identificador 262
#define token_cadena 263
#define suma 264
#define resta 265
#define multi 266
#define divi 267
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_token_entero = 5,               /* token_entero  */
  YYSYMBOL_token_real = 6,                 /* token_real  */
  YYSYMBOL_token_identificador = 7,        /* token_identificador  */
  YYSYMBOL_token_cadena = 8,               /* token_cadena  */
...
{
       0,    85,    85,    86,    87,    88,    89,    90,    93,   112,
     113,   114,   116,   117,   119,   120,   121,   122
};
#endif
...
static const char *const yytname[] =
{
  ...
  "exit_command", "token_entero", "token_real", "token_identificador",
  "token_cadena", "suma", "resta", "multi", "divi", "asignacion", "';'",
...
{
       2,    -4,     5,    -6,    14,    12,   -11,   -11,   -11,   -11,
      -4,     6,   -11,   -11,   -11,    -4,   -11,    -4,    16,    17,
     -11,    18,    -4,    -4,   -11,    15,    13,   -11,   -11,   -11,
     -11,   -11,   -11
};
...
{
       0,     0,     0,     0,     0,     0,    15,    14,    16,    17,
       0,     0,     9,    12,     3,     0,     1,     0,     0,     0,
       2,     0,     0,     0,     4,     8,     0,     7,     5,    13,
      10,    11,     6
};
...
{
      21,     6,     7,     8,     9,     1,     2,    15,    25,     3,
      26,    10,    30,    31,    16,    22,    23,    17,    18,    14,
      24,     3,    22,    23,    22,    23,    20,    32,    19,     0,
      27,    28,     0,     0,    29
};

static const yytype_int8 yycheck[] =
{
      10,     5,     6,     7,     8,     3,     4,    13,    15,     7,
      17,    15,    22,    23,     0,     9,    10,     3,     4,    14,
      14,     7,     9,    10,     9,    10,    14,    14,     4,    -1,
      14,    14,    -1,    -1,    16
};
...
{
       0,     3,     4,     7,    18,    19,     5,     6,     7,     8,
      15,    20,    21,    22,    14,    13,     0,     3,     4,    19,
      14,    21,     9,    10,    14,    20,    20,    14,    14,    16,
      21,    21,    14
};
...
#line 1251 "y.tab.c"
  ...
  case 8: /* assignment: token_identificador asignacion exp  */
#line 93 "s.y"
                                                 { 
                                            SymbolValue value;
                                            ...
                                            char* type = TYPEOF((yyvsp[0].real));
                                            if (type == "int") 
                                            {
                                                value.intValue = (yyvsp[0].real);
                                                insertSymbol(table, (yyvsp[-2].id), INT, value);
                                            }
...
#line 1280 "y.tab.c"
  ...
  case 10: /* exp: exp suma term  */
#line 113 "s.y"
                                {(yyval.real) = (yyvsp[-2].real) + (yyvsp[0].real);}
#line 1286 "y.tab.c"
    break;

  case 11: /* exp: exp resta term  */
#line 114 "s.y"
                                {(yyval.real) = (yyvsp[-2].real) - (yyvsp[0].real);}
#line 1292 "y.tab.c"
    break;
...
#line 1304 "y.tab.c"
  ...
  case 14: /* factor: token_real  */
#line 119 "s.y"
                                    {(yyval.id) = (yyvsp[0].real);}
#line 1310 "y.tab.c"
    break;

  case 15: /* factor: token_entero  */
#line 120 "s.y"
                                    {(yyval.id) = (yyvsp[0].entero);}
#line 1316 "y.tab.c"
    break;

  case 16: /* factor: token_identificador  */
#line 121 "s.y"
                                    {(yyval.id) = findSymbol(table, (yyvsp[0].id));}
#line 1322 "y.tab.c"
    break;

  case 17: /* factor: token_cadena  */
#line 122 "s.y"
                                     {(yyval.id) = (yyvsp[0].cadena);}
#line 1328 "y.tab.c"
    break;
